...
export default function OffreFormModal({ onClose, onSaved, initialData }: OffreFormModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.marque || !form.modele || !form.annee || !form.fournisseur_id || !form.prix_cif || !form.prix_ddp || !form.quantite_disponible) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-card rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-xl">
        <div className="sticky top-0 z-10 bg-card border-b border-border px-6 py-4 flex items-center justify-between rounded-t-2xl">
          ...
          <button onClick={onClose} className="p-2 rounded-full hover:bg-accent text-text-secondary">
            <X size={20} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-3">
              ...
              <div>
                ...
                <select
                  className={inputCls}
                  value={form.type}
                  onChange={(e) => setForm({ ...form, type: e.target.value as 'neuf' | 'occasion' })}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, motorisation: e.target.value })}
                />
              </div>
              <div>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4 mt-3">
              {hasPermission('offres_prix_achat') && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setForm({ ...form, prix_achat_interne: Number(e.target.value) })}
                  />
                </div>
              )}
              <div>
                ...
                <input
                  ...
                  className={inputCls}
                  value={form.prix_cif}
                  onChange={(e) => setForm({ ...form, prix_cif: Number(e.target.value) })}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className={inputCls}
                  value={form.prix_ddp}
                  onChange={(e) => setForm({ ...form, prix_ddp: Number(e.target.value) })}
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, delai_estime_jours: Number(e.target.value) })}
                />
              </div>
            </div>
          </section>
