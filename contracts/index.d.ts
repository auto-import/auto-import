...
export const VehicleSource: {
  ...
  readonly CLIENT_REQUEST: "clientRequest";
  readonly CHINA_OFFER: "chinaOffer";
...
export const PartnerType: {
  ...
  readonly CUSTOMS_BROKER: "customsBroker";
...
export const VehicleRequestStatus: {
  ...
  readonly CANDIDATE_SELECTED: "candidateSelected";
...
export const CrmLeadOutcome: { readonly LOST: "LOST" };
export type CrmLeadOutcome = ValueOf<typeof CrmLeadOutcome>;

export const CrmReferenceKind: {
  readonly ENTRY_CHANNEL: "ENTRY_CHANNEL";
  readonly MARKETING_SOURCE: "MARKETING_SOURCE";
  readonly COUNTRY: "COUNTRY";
};
export type CrmReferenceKind = ValueOf<typeof CrmReferenceKind>;
...
export const CustomsStatus: {
  readonly OPEN: "open";
  readonly DOCUMENTS_PENDING: "documentsPending";
...
export type DossierEvidenceCheckpoint = ValueOf<
  typeof DossierEvidenceCheckpoint
>;
...
export const Permission: {
  ...
  readonly OFFICES_READ: "offices:read";
  readonly OFFICES_WRITE: "offices:write";
  readonly ROLES_READ: "roles:read";
  readonly ROLES_WRITE: "roles:write";
  readonly ROLES_MANAGE: "roles:manage";
  readonly PROSPECTS_READ: "prospects:read";
  readonly PROSPECTS_WRITE: "prospects:write";
  readonly CLIENTS_READ: "clients:read";
  readonly CLIENTS_WRITE: "clients:write";
  readonly DOSSIERS_READ: "dossiers:read";
  readonly DOSSIERS_WRITE: "dossiers:write";
  readonly VEHICLES_READ: "vehicles:read";
  readonly VEHICLES_WRITE: "vehicles:write";
  readonly WAREHOUSES_READ: "warehouses:read";
  readonly WAREHOUSES_WRITE: "warehouses:write";
  readonly VEHICLE_REQUESTS_READ: "vehicleRequests:read";
  readonly VEHICLE_REQUESTS_WRITE: "vehicleRequests:write";
  readonly ORDERS_READ: "orders:read";
  readonly ORDERS_WRITE: "orders:write";
  readonly PURCHASES_READ: "purchases:read";
  ...
  readonly PAYMENTS_CONFIRM: "payments:confirm";
  readonly PAYMENTS_REVERSE: "payments:reverse";
  readonly INVOICES_READ: "invoices:read";
  readonly INVOICES_WRITE: "invoices:write";
  readonly INVOICES_ISSUE: "invoices:issue";
  readonly INVOICES_VOID: "invoices:void";
  readonly PAYMENT_PLANS_READ: "paymentPlans:read";
  readonly PAYMENT_PLANS_WRITE: "paymentPlans:write";
  readonly SUPPLIER_PAYMENTS_READ: "supplierPayments:read";
  readonly SUPPLIER_PAYMENTS_WRITE: "supplierPayments:write";
  readonly SUPPLIER_PAYMENTS_CONFIRM: "supplierPayments:confirm";
  readonly SUPPLIER_PAYMENTS_REVERSE: "supplierPayments:reverse";
  readonly COSTS_READ: "costs:read";
  readonly COSTS_WRITE: "costs:write";
  readonly EXCHANGE_RATES_READ: "exchangeRates:read";
  readonly EXCHANGE_RATES_WRITE: "exchangeRates:write";
  ...
  readonly GED_METADATA_READ: "gedMetadata:read";
  readonly GED_METADATA_CREATE: "gedMetadata:create";
  readonly GED_METADATA_UPDATE: "gedMetadata:update";
  readonly GED_METADATA_LINK: "gedMetadata:link";
  readonly GED_METADATA_UNLINK: "gedMetadata:unlink";
  readonly GED_METADATA_ARCHIVE: "gedMetadata:archive";
  readonly GED_AUDIT_READ: "gedAudit:read";
  readonly GED_BYTES_PREVIEW: "gedBytes:preview";
  readonly GED_BYTES_DOWNLOAD: "gedBytes:download";
  readonly GED_BYTES_UPLOAD: "gedBytes:upload";
  readonly GED_BYTES_CREATE_VERSION: "gedBytes:createVersion";
  readonly GED_VALIDATE: "gedValidation:validate";
  readonly GED_REJECT: "gedValidation:reject";
  readonly GED_SENSITIVE_METADATA: "gedSensitive:metadata";
  readonly GED_SENSITIVE_PREVIEW: "gedSensitive:preview";
  readonly GED_SENSITIVE_DOWNLOAD: "gedSensitive:download";
  readonly GED_SENSITIVE_UPLOAD: "gedSensitive:upload";
  readonly DOSSIER_CHECKLIST_READ: "dossierChecklist:read";
  readonly DOSSIER_CHECKLIST_MANAGE: "dossierChecklist:manage";
  readonly TASKS_READ: "tasks:read";
  readonly TASKS_WRITE: "tasks:write";
  ...
  readonly CRM_TIMELINE_READ: "crmTimeline:read";
  readonly CRM_TIMELINE_WRITE: "crmTimeline:write";
  readonly CALL_CENTER_ACCESS: "callCenter:access";
  readonly CALL_CENTER_DISPATCH: "callCenter:dispatch";
  readonly CALL_CENTER_HANDLE: "callCenter:handle";
  readonly WHATSAPP_HANDLE: "whatsapp:handle";
  readonly APPOINTMENTS_READ: "appointments:read";
  readonly APPOINTMENTS_WRITE: "appointments:write";
  readonly CRM_KPI_OWN: "crmKpi:own";
  readonly CRM_KPI_ORGANIZATION: "crmKpi:organization";
  ...
  readonly CLIENTS_IDENTITY_WRITE: "clients:identityWrite";
  readonly CLIENTS_ARCHIVE: "clients:archive";
...
export const DOSSIER_WORKFLOWS: Readonly<
  Record<DossierType, readonly DossierStatus[]>
>;
